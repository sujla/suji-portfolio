import{p as or,a as lo}from"./projects-KnV3ap8A.js";const rr=[{id:"store-finder",type:"e-commerce",href:"./projects/store-finder-renewal/",title:"Store Finder Renewal for Business Impact",companyLabel:"CJ Olive Young",year:2024,deviceType:"mobile",media:"store-guide",projectMedia:"./assets/common/store-guide-main.avif",cta:{label:"View Case Study",href:"./projects/store-finder-renewal/",newTab:!1}},{id:"article-studio",type:"enterprise",href:"./projects/modular-editorial-system/",title:"Editorial Workflow: From Weeks to Minutes",companyLabel:"CJ Olive Young",year:2024,deviceType:"web",projectMedia:"./assets/common/article-studio-main.avif",cta:{label:"View Case Study",href:"https://sujikweon.framer.website/article-studio",newTab:!0}},{id:"public-transport",type:"mobility",types:["ai","mobility"],title:"Public Transport App in SG",companyLabel:"Taurus Labs",year:2026,deviceType:"mobile",modalDescription:"Finding the right MRT exit and exploring transit routes on a full-screen map still felt harder than it should be. I built BusMrtSG to solve those transit-specific problems using AI coding tools and a serverless architecture."},{id:"cta-enhancement",type:"e-commerce",href:"./projects/cta-enhancement/",title:"Pickup Order UX Enhancement",companyLabel:"CJ Olive Young",year:2025,deviceType:"mobile",projectMedia:"./assets/common/cta-enh-main.avif",cta:{label:"View Case Study",href:"https://sujikweon.framer.website/cta-enhancement",newTab:!0}},{id:"perp-dex",type:"fintech",title:"Clearer Control for Perp Trading",companyLabel:"Taurus Labs",year:2025,deviceType:"mobile",modalDescription:"I redesigned the trading and wallet experience to streamline key workflows, helping users act with greater speed and confidence while improving portfolio visibility and transaction clarity."}],sr=(r,i,p)=>{if(!r)return;const f=760,b="portfolioPfModalProject",O=Object.entries({AI:"ai","Enterprise/SaaS":"enterprise",Fintech:"fintech","E-commerce":"e-commerce",Mobility:"mobility"}).map(([e,t])=>({label:e,value:t}));let k=null;const ue=e=>{const t=[e.companyLabel,e.year].filter(Boolean);return t.length?`<span>${t.join(" · ")}</span>`:""},Q=e=>{window.gtag?.("event","pf_work_card_click",{project_id:e.id,project_title:e.title})},T=()=>window.history.state?.[b]||"",yo=e=>{const t=window.history.state&&typeof window.history.state=="object"?window.history.state:{};window.history.pushState({...t,[b]:e},"")},lt=e=>e.deviceType==="web"?`
  ...
  `,ct=e=>{const t=wo[e-1];return`
    ...
    `},bo=e=>e.projectMedia?`<img class="pf-modal-project-media" src="${e.projectMedia}" alt="" />`:e.id==="public-transport"?ct(1):lt(e),Pe=[{start:0,end:5},{start:18,end:26}],vo=(e,t)=>{const o=e.id==="public-transport"?ct(t+2):"",s=e.id==="perp-dex"?[`
            ...
            `,`
              ...
              ${Z("Perpetual trading")}
            `][t]:"",a=e.media==="store-guide"&&t<Pe.length?`
        ...
        `:e.id==="article-studio"&&t===1?'<img class="pf-modal-article-studio-interface" src="./assets/article-studio/interface.png" alt="" />':"",x=e.media==="store-guide"&&t===2?`
          <div class="pf-modal-result">
    ...
    `;return t?`<div class="pf-work pf-work--${e.id} pf-work--clone" aria-hidden="true">${a}</div>`:`<a class="pf-work pf-work--${e.id}" href="${e.href}" data-project-types="${o.join(" ")}" draggable="false" aria-label="${p(e.title)} project detail">${a}</a>`},ut=e=>e.button===0&&!e.defaultPrevented&&!e.metaKey&&!e.ctrlKey&&!e.shiftKey&&!e.altKey,mt=(e,t)=>ut(e)&&!t.target&&!t.hasAttribute("download"),ft=()=>{const e=window.innerWidth<=600?12:16;return{top:e,left:e,width:window.innerWidth-e*2,height:window.innerHeight-e*2}},gt=()=>"24px",me=(e,t)=>{Object.assign(e.style,{top:`${t.top}px`,left:`${t.left}px`,width:`${t.width}px`,height:`${t.height}px`})},ht=(e,t)=>{const o=t.width?e.width/t.width:1,s=t.height?e.height/t.height:1,a=e.left-t.left,u=e.top-t.top;return`translate3d(${a}px, ${u}px, 0) scale(${o}, ${s})`},$o=()=>{const e=[...r.querySelectorAll(".pf-work video")],t=e.filter(o=>!o.paused&&!o.ended);return e.forEach(o=>o.pause()),t},Po=e=>{e.forEach(t=>{t.isConnected&&t.play().catch(()=>{})})},yt=(e,t,{pushHistory:o=!0}={})=>{if(k)return;o&&yo(t.id);const s=$o(),a=e.querySelector(".pf-work-card")||e,u=a.getBoundingClientRect(),m=window.getComputedStyle(a).borderRadius,w=ft(),x=gt(),y=document.createElement("div"),v=document.createElement("div"),n=document.createElement("div"),$=`pf-modal-${t.id}-title`,P=window.matchMedia("(prefers-reduced-motion: reduce)").matches,j=P?1:f,A=t.cta?`
      ...
      `),ne=z,be=!t.cta&&!g&&!ne,Je=t.deviceType==="web"&&!ne&&!be,Gt=t.id==="cta-enhancement",Xt=c=>{const h=Gt?c[0]:c.slice(0,2).join("");return g?`
        ...
        `:ne||be?c.join(""):Je?`<div class="pf-modal-bento-side">${c.slice(0,2).join("")}</div>`:`
          <div class="pf-modal-bento-stack">
            <div class="pf-modal-bento-stack-top${Gt?" pf-modal-bento-stack-top--single":""}">
              ${h}
            </div>
            ${c[2]}
          </div>
        `},Go=Xt(Yo),Xo=Xt(Ko),_o=g?"":`
  ...
  `,document.querySelector("[data-pf-work-cursor]")?.remove();const L=document.createElement("span");L.className="pf-work-cursor-label",L.dataset.pfWorkCursor="",L.setAttribute("aria-hidden","true"),L.innerHTML="<span>View Details</span>",document.body.append(L);const Ce=L.firstElementChild,wt=[...ee?[...ee.querySelectorAll("[data-project-type-filter]")]:[],...S.querySelectorAll("[data-project-type-filter]")],Ro=ee?.querySelector(".pf-type-filter"),bt=document.documentElement,R=S.querySelector(".pf-floating-filter-scroll"),Ae=[...S.querySelectorAll("[data-project-type-filter]")],xo=[...r.querySelectorAll(".pf-work[data-project-types]")],vt=r.querySelector(".pf-work-grid"),St=r.querySelector(".pf-filter-empty");let N="",Lt=0,kt=0,Tt=0,fe=!1;const qo=()=>{window.clearTimeout(kt),window.clearTimeout(Tt)},jo=e=>{if(e!==fe){if(fe=e,qo(),!e){S.classList.remove("is-visible"),Tt=window.setTimeout(()=>{fe||bt.classList.remove("is-footer-yielding-to-filter")},220);return}bt.classList.add("is-footer-yielding-to-filter"),kt=window.setTimeout(()=>{fe&&S.classList.add("is-visible")},220)}},ge=()=>{if(!R||!I.matches){S.classList.remove("has-scroll-left","has-scroll-right");return}const e=Math.max(0,R.scrollWidth-R.clientWidth);S.classList.toggle("has-scroll-left",R.scrollLeft>1),S.classList.toggle("has-scroll-right",R.scrollLeft<e-1)},Mt=()=>{if(!R||!I.matches)return;const e=Ae.find(a=>a.getAttribute("aria-pressed")==="true"),t=Ae.indexOf(e);if(!e)return;const o=Math.max(0,R.scrollWidth-R.clientWidth),s=t<2?0:t>=Ae.length-2?o:e.offsetLeft-(R.clientWidth-e.offsetWidth)/2;R.scrollTo({left:s,behavior:"smooth"})},Re=()=>{const e=r.getBoundingClientRect().bottom,t=window.innerHeight*Ao;jo(window.scrollY>Co&&e>t)},Fo=()=>{const e=Math.max(0,r.getBoundingClientRect().top+window.scrollY-10);window.scrollTo({top:e,behavior:"smooth"})},Et=e=>{N=e;let t=0;wt.forEach(o=>{o.setAttribute("aria-pressed",String(o.dataset.projectTypeFilter===N))}),Mt(),Ro?.classList.toggle("is-filtering",!!N),xo.forEach(o=>{const s=o.dataset.projectTypes.split(" "),a=!N||s.includes(N);o.hidden=!a,a&&(t+=1)}),vt?.classList.toggle("is-single-result",t===1),St&&(St.hidden=t>0)};wt.forEach(e=>{e.addEventListener("click",()=>{const t=document.documentElement,o=e.dataset.projectTypeFilter,s=!S.contains(e)&&N===o;window.clearTimeout(Lt),t.style.overflowAnchor="none",Et(s?"":o),Fo(),Lt=window.setTimeout(()=>{t.style.removeProperty("overflow-anchor")},700)})}),window.addEventListener("scroll",Re,{passive:!0}),window.addEventListener("resize",()=>{Re(),ge()},{passive:!0}),R?.addEventListener("scroll",ge,{passive:!0}),I.addEventListener?.("change",()=>{ge(),Mt()}),Re(),Et(""),ge();const l=r.querySelector("[data-pf-work-rail]"),xe=l?[...l.querySelectorAll(".pf-work-set")]:[],$t=r.querySelector(".pf-work-set--primary .pf-work"),d=r.querySelector("[data-pf-work-rail-secondary]"),he=d?[...d.querySelectorAll(".pf-work-set")]:[],Pt=he[1]?.querySelector(".pf-work:nth-child(4)");r.querySelector("[data-mobile-pf-work-rail]"),r.querySelector("[data-mobile-pf-work-rail-secondary]");const Wo=80,Io=-80,qe=32,Bo=12,Ct=180,At=600;let je,Fe=0,We=0,M=0,Ie=qe,Be=!1,te=!1,Rt=0,He=0,oe=!1,ye=!1,re=!1,De=0,B=0,Y=0,W=0,K=0,E=0,Ve=0,se=!1,xt=0,ze=0,ie=!1,we=!1,ae=!1,Oe=0;const qt=({preservePosition:e=!1}={})=>{if(!l||!$t||xe.length<3)return;const t=B,o=Y,s=t?(l.scrollLeft-o)/t:0,a=l.getBoundingClientRect(),u=$t.getBoundingClientRect(),m=l.scrollLeft+u.left-a.left;B=xe[2].getBoundingClientRect().left-xe[1].getBoundingClientRect().left,Y=m-(l.clientWidth-u.width)/2-(I.matches?Wo:0),l.scrollLeft=e?Y+s*B:Y,M=l.scrollLeft},Ne=()=>{if(!l||!B)return 0;const e=Y-B*.5,t=Y+B*.5;let o=l.scrollLeft;for(;o<e;)o+=B;for(;o>=t;)o-=B;const s=o-l.scrollLeft;return Math.abs(s)>.5&&(l.scrollLeft=o),s},jt=({preservePosition:e=!1}={})=>{if(!d||!Pt||he.length<3||!d.clientWidth)return;const t=W,o=K,s=t?(d.scrollLeft-o)/t:0,a=d.getBoundingClientRect(),u=Pt.getBoundingClientRect(),m=d.scrollLeft+u.left-a.left;W=he[2].getBoundingClientRect().left-he[1].getBoundingClientRect().left,K=m-(d.clientWidth-u.width)/2-Io,d.scrollLeft=e?K+s*W:K,E=d.scrollLeft},Ye=()=>{if(!d||!W)return 0;const e=K-W*.5,t=K+W*.5;let o=d.scrollLeft;for(;o<e;)o+=W;for(;o>=t;)o-=W;const s=o-d.scrollLeft;return Math.abs(s)>.5&&(d.scrollLeft=o),s},Ke=()=>{M=l?.scrollLeft??M,We=performance.now()+200},Ft=()=>{E=d?.scrollLeft??E,Ve=performance.now()+200},Ho=()=>{window.clearTimeout(De),re=!0,M=l?.scrollLeft??M},Wt=()=>{window.clearTimeout(De),De=window.setTimeout(()=>{l&&(M=l.scrollLeft,M+=Ne(),re=!1,We=performance.now()+At)},Ct)},Do=()=>{window.clearTimeout(Oe),ae=!0,E=d?.scrollLeft??E},It=()=>{window.clearTimeout(Oe),Oe=window.setTimeout(()=>{d&&(E=d.scrollLeft,E+=Ye(),ae=!1,Ve=performance.now()+At)},Ct)},Bt=e=>{const t=Math.min((e-(je??e))/1e3,.1),o=Be?Bo:qe;if(je=e,Ie+=(o-Ie)*Math.min(t*6,1),l){const s=r.getBoundingClientRect(),a=s.bottom>0&&s.top<window.innerHeight;a&&!te&&!re&&!ae&&!document.documentElement.classList.contains("is-pf-modal-open")&&e>=We&&(M+=t*Ie,l.scrollLeft=M,M+=Ne()),a&&d?.clientWidth&&W&&!se&&!ae&&!re&&!document.documentElement.classList.contains("is-pf-modal-open")&&e>=Ve&&(E-=t*qe,d.scrollLeft=E,E+=Ye())}Fe=requestAnimationFrame(Bt)};!l||Fe||(je=void 0,Fe=requestAnimationFrame(Bt)),requestAnimationFrame(()=>{qt(),jt()}),l?.addEventListener("mouseenter",()=>{Be=!0}),l?.addEventListener("mouseleave",()=>{Be=!1}),r.addEventListener("wheel",e=>{!l||e.ctrlKey||(Ke(),(e.shiftKey||Math.abs(e.deltaX)>Math.abs(e.deltaY))&&e.preventDefault())},{passive:!1}),l?.addEventListener("pointerdown",e=>{if(!(e.button!==0||k)){if(e.pointerType==="touch"&&I.matches){Ho();return}te=!0,oe=!1,Rt=e.clientX,He=l.scrollLeft,Ke()}}),l?.addEventListener("dragstart",e=>{e.preventDefault()}),l?.addEventListener("pointermove",e=>{if(!te)return;const t=e.clientX-Rt;!oe&&Math.abs(t)<=5||(oe||(oe=!0,l.classList.add("is-dragging"),l.setPointerCapture(e.pointerId)),l.scrollLeft=He-t,He+=Ne(),M=l.scrollLeft,Ke())});const Vo=e=>{!l||!te||(te=!1,l.classList.remove("is-dragging"),l.hasPointerCapture(e.pointerId)&&l.releasePointerCapture(e.pointerId),M=l.scrollLeft,oe&&(ye=!0,window.setTimeout(()=>{ye=!1},0)))};l?.addEventListener("scroll",()=>{re&&(M=l.scrollLeft,Wt())},{passive:!0});const Ht=e=>{if(e.pointerType==="touch"&&I.matches){Wt();return}Vo(e)};l?.addEventListener("pointerup",Ht),l?.addEventListener("pointercancel",Ht),l?.addEventListener("click",e=>{ye&&(ye=!1,e.preventDefault(),e.stopPropagation())},!0),d?.addEventListener("pointerdown",e=>{if(!(e.button!==0||k)){if(e.pointerType==="touch"&&I.matches){Do();return}se=!0,ie=!1,xt=e.clientX,ze=d.scrollLeft,Ft()}}),d?.addEventListener("dragstart",e=>{e.preventDefault()}),d?.addEventListener("pointermove",e=>{if(!se)return;const t=e.clientX-xt;!ie&&Math.abs(t)<=5||(ie||(ie=!0,d.classList.add("is-dragging"),d.setPointerCapture(e.pointerId)),d.scrollLeft=ze-t,ze+=Ye(),E=d.scrollLeft,Ft())});const zo=e=>{!d||!se||(se=!1,d.classList.remove("is-dragging"),d.hasPointerCapture(e.pointerId)&&d.releasePointerCapture(e.pointerId),E=d.scrollLeft,ie&&(we=!0,window.setTimeout(()=>{we=!1},0)))};d?.addEventListener("scroll",()=>{ae&&(E=d.scrollLeft,It())},{passive:!0});const Dt=e=>{if(e.pointerType==="touch"&&I.matches){It();return}zo(e)};d?.addEventListener("pointerup",Dt),d?.addEventListener("pointercancel",Dt),d?.addEventListener("click",e=>{we&&(we=!1,e.preventDefault(),e.stopPropagation())},!0);const Oo=70,Ge=14,Xe=12;let V=0,Vt=L.offsetWidth,_e=L.offsetHeight;const Ue=()=>{Vt=L.offsetWidth,_e=L.offsetHeight},zt=e=>{!Ce||Ce.textContent===e||(Ce.textContent=e,Ue())};document.fonts?.ready.then(Ue);const G=(e=0)=>{if(e){if(V)return;V=window.setTimeout(()=>{V=0,L.classList.remove("is-visible")},e);return}window.clearTimeout(V),V=0,L.classList.remove("is-visible")},Ot=()=>{window.clearTimeout(V),V=0,L.classList.add("is-visible")},Nt=e=>{const t=Vt/2,o=Math.min(Math.max(t+Xe,e.clientX),window.innerWidth-t-Xe),a=e.clientY+Ge+_e+Xe<=window.innerHeight?e.clientY+Ge:e.clientY-Ge-_e;L.style.transform=`translate3d(${o}px, ${a}px, 0) translateX(-50%)`};document.addEventListener("pointermove",e=>{if(e.pointerType!=="mouse")return;const t=e.target instanceof Element?e.target:null,o=t?.closest("[data-cursor-label]"),s=t?.closest(".pf-work");if(o){zt(o.dataset.cursorLabel||"View Details"),Nt(e),Ot();return}if(s&&r.contains(s)){zt("View Details"),Nt(e),Ot();return}if(t&&vt?.contains(t)){G(Oo);return}G()}),r.addEventListener("pointerleave",()=>G()),window.addEventListener("blur",()=>G()),window.addEventListener("scroll",()=>G(),{passive:!0}),r.querySelectorAll(".pf-work").forEach(e=>{e.addEventListener("click",t=>{if(!mt(t,e))return;const o=i.find(s=>e.classList.contains(`pf-work--${s.id}`));o&&(Q(o),G(),t.preventDefault(),yt(e,o))})}),window.addEventListener("resize",()=>{Ue(),requestAnimationFrame(()=>{qt({preservePosition:!0}),jt({preservePosition:!0})})});const Yt=()=>{const e=T();if(k){k.projectId!==e&&k.closeModal();return}if(!e)return;const t=i.find(s=>s.id===e),o=r.querySelector(`.pf-work--${e}:not(.pf-work--clone)`);t&&o&&yt(o,t,{pushHistory:!1})};return window.addEventListener("popstate",Yt),{resetModal:()=>k?.disposeModal(),syncModalWithHistory:Yt}},ot=document.querySelector("[data-pf]"),to=document.querySelector("[data-about]"),_=document.querySelector(".about-photo-stack"),oo=document.querySelector("[data-project-list]"),ir=document.querySelector("[data-current-project]");document.querySelector("[data-total-projects]");const ar=document.querySelector(".counter-line"),ro=document.querySelector(".fixed-project-meta"),nr=document.querySelector("[data-side-number]"),lr=document.querySelector("[data-side-wip]"),cr=document.querySelector("[data-side-title]"),dr=document.querySelector("[data-counter-wip]"),rt=document.querySelector("[data-year-rail]"),pr=[...document.querySelectorAll("[data-gnb-scroll]")],co=document.querySelector(".theme-toggle"),U=document.documentElement,po="portfolio-last-project-slug",so=760,ur=12,mr=8,uo=window.matchMedia("(max-width: 600px)"),at=window.matchMedia("(prefers-reduced-motion: reduce)"),fr=3e3,gr=200,hr={work:40,experience:-50};let st=!1,pe=0,tt=0,io=0,mo=0;const yr=()=>{const r=_?.lastElementChild;!r||_.children.length<2||r.classList.contains("is-moving-to-back")||(r.classList.add("is-moving-to-back"),mo=window.setTimeout(()=>{_.prepend(r),window.requestAnimationFrame(()=>r.classList.remove("is-moving-to-back"))},gr))},fo=()=>{window.clearInterval(io),window.clearTimeout(mo),_?.querySelector(".is-moving-to-back")?.classList.remove("is-moving-to-back"),!(!_||_.children.length<2||at.matches)&&(io=window.setInterval(yr,fr))},wr=r=>{try{return window.sessionStorage?.getItem(r)||""}catch{return""}},br=(r,i)=>{try{window.sessionStorage?.setItem(r,i)}catch{}},vr=r=>{window.gtag?.("event","project_click",{project_name:r})},Sr=r=>`'${String(r).slice(-2)}`,Lr=r=>{const{start:i,end:p}=lo.yearRange,f=Math.min(5,p-i+1),b=Math.min(Math.max(r-2,i),p-f+1);return Array.from({length:f},(J,O)=>b+O)},kr=r=>r.split("|").join(" "),Tr=(r,i)=>r.button===0&&!r.defaultPrevented&&!r.metaKey&&!r.ctrlKey&&!r.shiftKey&&!r.altKey&&!i.target&&!i.hasAttribute("download"),Mr=()=>window.matchMedia("(max-width: 600px)").matches?mr:ur,Er=()=>{const r=Mr();return{top:r,left:r,width:window.innerWidth-r*2,height:window.innerHeight-r*2}},$r=r=>{const i=r.getBoundingClientRect(),p=Er(),f=window.getComputedStyle(r),b=window.getComputedStyle(r.querySelector(".project-media")),J=r.querySelector(".project-summary"),O=Number.parseFloat(f.rowGap||f.gap)||0,k=J?.getBoundingClientRect().height||0,ue=Math.max(0,p.height-k-O),Q=document.createElement("div"),T=r.cloneNode(!0);return T.classList.add("project-transition-card"),T.removeAttribute("href"),T.removeAttribute("aria-label"),T.setAttribute("aria-hidden","true"),Object.assign(T.style,{top:`${i.top}px`,left:`${i.left}px`,width:`${i.width}px`,height:`${i.height}px`,gap:f.gap,gridTemplateRows:f.gridTemplateRows,maxHeight:"none"}),T.style.setProperty("--project-media-shadow",b.boxShadow),Q.className="project-transition-layer",Q.append(T),document.body.append(Q),{cardClone:T,targetRect:p,targetGridTemplateRows:`${ue}px ${k}px`}},Pr=r=>{if(st)return;const i=r.closest(".project-section");if(!i){window.location.href=r.href;return}st=!0,i.classList.add("is-transition-source"),document.body.classList.add("is-project-transitioning"),document.documentElement.classList.add("is-project-transitioning");const{cardClone:p,targetRect:f,targetGridTemplateRows:b}=$r(r);p.animate([{top:p.style.top,left:p.style.left,width:p.style.width,height:p.style.height,gridTemplateRows:p.style.gridTemplateRows,opacity:1,offset:0},{opacity:1,offset:.9},{top:`${f.top}px`,left:`${f.left}px`,width:`${f.width}px`,height:`${f.height}px`,gridTemplateRows:b,opacity:0,offset:1}],{duration:so,easing:"cubic-bezier(0.16, 1, 0.3, 1)",fill:"forwards"}),window.setTimeout(()=>{window.location.href=r.href},so-120)},Cr=()=>{st=!1,document.documentElement.classList.remove("is-project-transitioning"),document.body.classList.remove("is-project-transitioning"),document.querySelectorAll(".project-transition-layer").forEach(r=>r.remove()),document.querySelectorAll(".is-transition-source").forEach(r=>{r.classList.remove("is-transition-source")})},Ar=r=>{rt.innerHTML=Lr(r.year).map(i=>{const p=i===r.year;return`
        <span class="year-rail-item" data-year="${i}" ${p?'aria-current="true"':""}>${Sr(i)}</span>
      `}).join("")},Rr=()=>{ro.classList.add("is-changing"),rt.classList.add("is-changing"),window.setTimeout(()=>{ro.classList.remove("is-changing"),rt.classList.remove("is-changing")},180)};let Ee=[],ao=-1;const nt=({force:r=!1}={})=>{if(!uo.matches){pe&&(U.style.removeProperty("--mobile-project-viewport"),pe=0,tt=0);return}const i=window.innerWidth;!r&&pe&&i===tt||(pe=window.innerHeight,tt=i,U.style.setProperty("--mobile-project-viewport",`${pe}px`))},xr=()=>{if(!ot)return;const r=ot.getBoundingClientRect(),i=window.innerHeight/2,p=r.top<=i&&r.bottom>=i;U.classList.toggle("is-pf-active",p)},qr=()=>{if(!to)return;const r=to.getBoundingClientRect(),i=window.innerHeight/2,p=r.top<=i&&r.bottom>=i;U.classList.toggle("is-about-active",p)},jr=r=>{if(r===ao||r<0)return;const i=or[r],p=(r+1)/lo.totalProjectCount*100;ao=r,Rr(),ir.textContent=i.number,nr.textContent=i.number,lr.textContent=i.wip?"🚧":"",dr.textContent=i.wip?"🚧":"",cr.innerHTML=i.sideTitle.split("|").join("<br />"),ar.style.setProperty("--progress",`${p}%`),br(po,i.slug),Ar(i)},Fr=()=>{if(!Ee.length)return;const r=window.innerHeight/2,i=Ee.map((p,f)=>{const b=p.getBoundingClientRect(),J=b.top+b.height/2;return{index:f,distance:Math.abs(J-r)}}).sort((p,f)=>p.distance-f.distance)[0]?.index;Ee.forEach((p,f)=>{const b=f===i;p.classList.toggle("is-active",b),p.classList.toggle("is-inactive",!b)}),jr(i)},Wr=r=>{const i=Math.max(0,document.documentElement.scrollHeight-window.innerHeight),p=hr[r.id]??0,f=r===document.body?0:r.getBoundingClientRect().top+window.scrollY-p,b=Math.min(i,Math.max(0,f));window.scrollTo({top:b,behavior:at.matches?"auto":"smooth"})};let no=0;const $e=()=>{cancelAnimationFrame(no),no=requestAnimationFrame(()=>{xr(),qr(),Fr()})},go=r=>{U.dataset.theme=r,co.setAttribute("aria-pressed",String(r==="dark")),localStorage.setItem("portfolio-theme",r)},Ir=localStorage.getItem("portfolio-theme")||"light",ho=()=>window.performance.getEntriesByType("navigation")[0]?.type||"navigate";at.addEventListener?.("change",fo);fo();const it=sr(ot,rr,kr);Ee=[...document.querySelectorAll("[data-project]")];nt({force:!0});go(Ir);const Br=()=>{const r=window.location.hash?window.location.hash.slice(1):"",i=ho()==="back_forward",p=r||(i?wr(po):""),f=p?document.getElementById(p):null;r&&window.history.replaceState(null,"",`${window.location.pathname}${window.location.search}`),f&&f.scrollIntoView({block:"center",behavior:"auto"})};Br();ho()==="reload"&&window.requestAnimationFrame(()=>window.scrollTo({top:0,behavior:"auto"}));co.addEventListener("click",()=>{go(U.dataset.theme==="dark"?"light":"dark")});pr.forEach(r=>{r.addEventListener("click",i=>{const p=document.querySelector(r.hash);p&&(i.preventDefault(),Wr(p))})});oo?.addEventListener("click",r=>{const i=r.target.closest(".project-link");!i||!oo.contains(i)||!Tr(r,i)||(vr(i.closest(".project-section")?.dataset.analyticsId),r.preventDefault(),Pr(i))});window.addEventListener("scroll",$e,{passive:!0});window.addEventListener("resize",()=>{nt(),$e()});uo.addEventListener?.("change",()=>{nt({force:!0}),$e()});window.addEventListener("pagehide",()=>it?.resetModal());window.addEventListener("pageshow",()=>{it?.resetModal(),it?.syncModalWithHistory(),Cr()});$e();
